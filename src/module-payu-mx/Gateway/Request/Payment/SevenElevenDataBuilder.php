...
namespace Eloom\PayUMx\Gateway\Request\Payment;
...
class SevenElevenDataBuilder implements BuilderInterface {
	...
	public function build(array $buildSubject) {
		...
		return [AuthorizeDataBuilder::TRANSACTION => [
			self::PAYMENT_METHOD => PaymentMethod::memberByKey('seveneleven')->getCode(),
